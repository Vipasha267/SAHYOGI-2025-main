      ...
      <>
        ...
        <>
          ...
          <div className="relative overflow-hidden">
            ...
            >
              <div className="bg-linear-to-r from-lime-300/50 to-lime-100 blur-3xl w-100 h-175 rotate-[-60deg] transform -translate-x-40 dark:from-lime-500/50 dark:to-lime-900" />
              <div className="bg-linear-to-tl from-lime-50 via-lime-100 to-lime-50 blur-3xl w-[1440px] h-200 rounded-fulls origin-top-left -rotate-12 -translate-x-60 dark:from-lime-900/70 dark:via-lime-900/70 dark:to-lime-900/70" />
            </div>
            {/* End Gradients */}
        ...
        {/* ========== FOOTER ========== */}
        <footer className="mt-auto bg-lime-500 w-full dark:bg-neutral-950">
          <div className="mt-auto w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
              ...
              <div className="col-span-1">
                <h4 className="font-semibold text-gray-100">About SAHYOGI</h4>
                <div className="mt-3 grid space-y-3">
                  <p>
                    <a
                      ...
                      href="#"
                    >
                      'Helping India's true Heroes shine'
                    </a>
                  </p>
                  <p>
                    <a
              ...
              <div className="col-span-1">
                ...
                <div className="mt-3 grid space-y-3">
                  ...
                  <p>
                    ...
                    <span className="inline-block ms-1 text-xs bg-lime-500 text-black py-1 px-2 rounded-lg">
                      Support
                    </span>
                  </p>
                  <p>
                  ...
                  <div className="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-white rounded-lg p-2 dark:bg-neutral-900">
                    <div className="w-full">
                      ...
                      <input
                        ...
                        id="hero-input"
                        name="hero-input"
                        className="py-2.5 sm:py-3 px-4 block w-full border-transparent rounded-lg sm:text-sm focus:border-lime-500 focus:ring-lime-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-transparent dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600"
                        placeholder="Enter your email"
                      />
                    </div>
                    <a
                      className="w-full sm:w-auto whitespace-nowrap p-3 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-lime-500 text-black hover:bg-lime-500 focus:outline-hidden focus:bg-lime-500 disabled:opacity-50 disabled:pointer-events-none"
                      href="#"
                    >
                      Subscribe
                    </a>
            ...
            <div className="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
              <div className="flex flex-wrap justify-between items-center gap-2">
                <p className="text-sm text-gray-400 dark:text-neutral-400">
                  © 2025 SAHYOGI. All rights reserved
                </p>
              </div>
              {/* End Col */}
              {/* Social Brands */}
