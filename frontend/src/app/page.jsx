          ...
          <div className="relative z-10">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-16">
              <div className="text-center mx-auto">
                ...
                {/* Responsive Gallery */}
                <div className="flex flex-col md:flex-row md:-m-2 -m-1">
                  <div className="flex flex-row md:flex-col w-full md:w-1/2">
                    <div className="md:p-2 p-1 w-1/2 md:w-full">
                      <img
                        alt="gallery"
                        className="w-full h-40 md:h-full object-cover object-center block rounded-lg"
