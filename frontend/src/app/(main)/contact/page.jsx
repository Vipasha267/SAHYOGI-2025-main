            ...
            <form onSubmit={contactForm.handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-transparent ${contactForm.touched.fullName && contactForm.errors.fullName
                      ? 'border-red-500'
                      : 'border-gray-300'
                    }`}
                />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-transparent ${contactForm.touched.email && contactForm.errors.email
                        ? 'border-red-500'
                        : 'border-gray-300'
                      }`}
                  />
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-transparent ${contactForm.touched.phone && contactForm.errors.phone
                        ? 'border-red-500'
                        : 'border-gray-300'
                      }`}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-transparent ${contactForm.touched.subject && contactForm.errors.subject
                        ? 'border-red-500'
                        : 'border-gray-300'
                      }`}
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-transparent ${contactForm.touched.inquiryType && contactForm.errors.inquiryType
                        ? 'border-red-500'
                        : 'border-gray-300'
                      }`}
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  className={`w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-lime-500 focus:border-transparent ${contactForm.touched.message && contactForm.errors.message
                      ? 'border-red-500'
                      : 'border-gray-300'
                    }`}
                />
              ...
              <button
                ...
                className={`w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-lime-600 hover:bg-lime-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-lime-500 ${isSubmitting ? 'opacity-50 cursor-not-allowed' : ''
                  }`}
              >
                {isSubmitting ? (
